var traducir = document.getElementById('btn-traducir');
traducir.addEventListener('click', clickTraducir)

function clickTraducir() {
  let res = document.getElementById('res')
  res.innerHTML = platzon(document.getElementById('txt').value);;
}
